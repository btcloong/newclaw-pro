  ...
  levels: [
    {
      ...
      content: [
        ...
        { title: "工具调用 (Tool Use)", desc: "学习如何让 Agent 使用外部工具" },
...
researcher = Agent(role="研究员", goal="收集AI资讯", backstory="资深研究员")
writer = Agent(role="作家", goal="撰写文章", backstory="写作专家")
...
model.print_trainable_parameters()  # 只训练 0.28% 参数`
    },
    {
      level: "阶段三",
      title: "模型优化与导出",
...
const knowledgeBase = {
  title: "AI 学习大全",
  subtitle: "系统掌握 AI 核心概念与知识体系",
  concepts: [
    { name: "机器学习", desc: "监督/无监督/强化学习", resources: ["吴恩达 ML 课程", "Google ML Crash Course"] },
    { name: "深度学习", desc: "神经网络、CNN、RNN、Transformer", resources: ["Fast.ai", "CS231n"] },
    { name: "大语言模型", desc: "GPT、Claude、Llama 架构原理", resources: ["Hugging Face Course", "CS224N"] },
    { name: "生成式 AI", desc: "文本/图像/音频/视频生成", resources: ["Stable Diffusion", "OpenAI Cookbook"] },
    { name: "RAG", desc: "检索增强生成、向量数据库", resources: ["LlamaIndex 文档", "LangChain RAG"] },
    { name: "AI Agent", desc: "ReAct、工具使用、多 Agent 协作", resources: ["ReAct 论文", "AutoGen 文档"] },
  ],
  papers: [
          ...
          {currentPath ? (
                    ...
                    <CardHeader className="cursor-pointer hover:bg-gray-50" onClick={() => setExpandedLevel(expandedLevel === idx ? null : idx)}>
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          <div className={`w-12 h-12 rounded-lg flex items-center justify-center ${activeTab === "agent" ? "bg-purple-100 text-purple-600" : "bg-blue-100 text-blue-600"}`}>
                        ...
                        <ChevronRight className={`w-5 h-5 text-gray-400 transition-transform ${expandedLevel === idx ? "rotate-90" : ""}`} />
                      </div>
                    </CardHeader>
            ...
            <div>
              <div className="mb-8">
                ...
                <p className="text-xl text-gray-600">{knowledgeBase.subtitle}</p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {knowledgeBase.concepts.map((item, idx) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {knowledgeBase.papers.map((paper, idx) => (
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-3">
                      {knowledgeBase.tools.map((tool, idx) => (
                        <div key={idx} className="p-3 bg-gray-50 rounded-lg">
